export default function Hero() {
  return (
    <div className="relative w-full max-h-[500px] h-screen flex items-center justify-center bg-gray-900 text-white  bg-fixed bg-center bg-cover bg-no-repeat bg-[url(/assets/bg-hero.webp)]">
