  ...
  return (
    <div className="relative w-full">
      <input
        ...
        onBlur={handleBlur}
        placeholder=" "
        className={`peer w-full border-t-0 border-x-0 border-b-0.5 px-4 pt-6 pb-2 text-gray-900 bg-transparent transition-all duration-300 
          ${
            error
              ? "border-red-500 focus:border-red-500 focus:ring-red-500"
              : "border-gray-300 focus:border-[#5B3E40] focus:ring-[#5B3E40]"
          }`}
      />
      <label
        htmlFor={name}
        className={`absolute left-4 top-2 text-sm transition-all font-medium
          ...
          ${
            error
              ...
              : "text-gray-400 peer-focus:text-[#5B3E40]"
          }`}
      >
        {label}
      </label>
